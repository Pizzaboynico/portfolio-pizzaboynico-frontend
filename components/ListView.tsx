        ...
        <>
            ...
            >
                ...
                <div className="list-header">
                    <span className="list-col-id">#</span>
                    <span className="list-col-title">Project</span>
                    <span className="list-col-asset">Asset</span>
                ...
                {projects.map((project, i) => (
                    ...
                    >
                        <span className="list-col-id">
                            {project.projectNumber
                                ? String(project.projectNumber).padStart(2, "0")
                                : String(i + 1).padStart(2, "0")}
                        </span>
                        <span className="list-col-title">{project.title}</span>
                        <span className="list-col-asset">
                            {project.assetName || "—"}
                        </span>
                        <span className="list-col-year">{project.year || "—"}</span>
                    </motion.div>
                ))}
            </motion.div>
